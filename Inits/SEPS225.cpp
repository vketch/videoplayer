...
void SEPS225::init()
{
   ...
   oled = new SPI(PIN_OLED_MOSI, PIN_OLED_MISO, PIN_OLED_SCLK) ;
    ...
    reg_write(CMD_REDUCE_CURRENT, 0x01) ;  ThisThread::sleep_for(10ms) ; //    oled_delay(100000) ;
    reg_write(CMD_REDUCE_CURRENT, 0x00) ;  ThisThread::sleep_for(10ms) ; //    oled_delay(100000) ;
